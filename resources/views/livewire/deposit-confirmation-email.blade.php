     ...
     <div class="cols-12 col-md-7">
         <div class="panel">
             <div class="panel-heading">
                 <div class="panel-title">
                     <center>
                         <b>Deposit confirmation email</b>
                     </center>
                 </div>
             </div>
             <div class="panel-body">
                 <form action="" wire:submit.prevent="update">
                     <div class="form-group">
                         ...
                         <input type="text" wire:model="depositSubjectField" name="subject" placeholder=""
                             class="form-control" required />
                     </div>
                     <div class="form-group">
                         <label for="message">Message</label>
                         <textarea name="message" wire:model="depositMessageField" id="" class="form-control" cols="30"
