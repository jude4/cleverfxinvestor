            ...
            <div class="cols-12 col-md-8 offset-md-2">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="" wire:submit.prevent="addReview({{ $review->id }})">
                            @csrf
                            <div class="form-group">
                                <label for="Name">Name</label>
                                <input type="text" placeholder="{{ $review->name }}" wire:model="name" name="name"
                                    class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="message" wire:model="message" class="form-control" id="" cols="30"
                                    rows="10" placeholder="{{ $review->message }}">
