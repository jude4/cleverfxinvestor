...
@section('script')
  ...
  <script src="widget/js/jquery-3.4.1.min.js"></script>
  <script src="widget/js/popper.min.js"></script>
  <script src="widget/js/bootstrap.min.js"></script>
  <script src="widget/js/amcharts-core.min.js"></script>
  <script src="widget/js/amcharts.min.js"></script>
  <script src="widget/js/jquery.mCustomScrollbar.js"></script>
  <script src="widget/js/custom.js"></script>
  <script>
